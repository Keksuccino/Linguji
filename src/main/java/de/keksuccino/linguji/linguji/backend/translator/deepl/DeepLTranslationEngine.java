 ...
 */
public class DeepLTranslationEngine implements ITranslationEngine {
    ...
    public DeepLTranslationEngine(@NotNull String apiKey) {
    ...
    public @Nullable String translate(@NotNull String text, @NotNull String sourceLanguage, @NotNull String targetLanguage, @NotNull TranslationProcess process) throws Exception {
        ...
        String json = Objects.requireNonNull(gson.toJson(new DeepLRequest(targetLanguage, text)));
